                ...
                <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                    <div className="p-6">
                        ...
                        <div className="relative my-6 text-center">
                            ...
                            <span className="relative px-4 text-[10px] font-bold text-gray-400 bg-white uppercase tracking-widest">Ou continuer avec</span>
                        </div>

                        <button
                            onClick={handleGoogleLogin}
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-3 p-3 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all active:scale-95 disabled:opacity-50"
                        >
